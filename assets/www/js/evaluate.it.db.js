...
var json = function() {
	...
	// var url =
	// "http://www.metroblooms.org/app/gardens.php?output=json&callback=?";
	// grab all evaluation data specific to an evaluator_id
	var url = "http://www.metroblooms.org/app/evaluations.php?callback=&evaluator_id=265"; // 265=gms;
	// 116=Becky
...
function SendJson(obj, id) {
	...
	$.ajax({
		type : "POST",
		url: "http://www.metroblooms.org/applive/updateData.php", // to POST
		// updates/edits
		//url : "http://www.metroblooms.org/applive/showPostedData.php", // for
		// testing
		// dataType : "json",
